...
--           , signal :: IxSignal (Effects eff) (Maybe (Array DietTag))
--           }
--         , decisions ::
...
-- spec {search,submit,results,decisions,tagSearch} = T.simpleSpec performAction render
--   where
...
diets {tagSearch,dietTagSearchResultsQueue} =
  ...
  -- where
    ...
    -- resultsSignal = unsafePerformEff $ IxSignal.make Nothing
